...
<fieldset>
<legend><?=L('recovery')?></legend>
<form name="form" method="post" action="<?=U('do_recovery')?>" onsubmit="return check_form()">
...
<tr>
	<th><?=L('newpass')?>:</th>
	<td><input type="password" name="upass1" maxlength="32" required="required" placeholder="请设置新密码" /></td>
</tr>
<tr>
	<th><?=L('repeatpass')?>:</th>
...
<tr>
	<th></th>
	<td><button type="submit"><?=L('recovery')?></button></td>
</tr>
</tfoot>
</table>
</form>
